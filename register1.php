...
$username = $password = $confirm_password = $address = $city= $state = $zip = $phone ="";
...
if(empty($username_err) && empty($password_err) && empty($confirm_password_err))
{
    ...
    $sql = "INSERT INTO users (username, password,address,city,state,zip,phone) VALUES ('$username', '$password', '$address','$city','$state','$zip','$phone')";
    $stmt = mysqli_prepare($conn, $sql);
    if ($stmt)
    {
        // mysqli_stmt_bind_param($stmt, "sssssi", $param_username, $param_password,$param_address,$param_city,$param_state,$param_zip);
